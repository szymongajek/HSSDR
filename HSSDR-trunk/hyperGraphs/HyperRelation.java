...
public class HyperRelation extends RelationHE{
	...
	private ArrayList<Node> incidents = new ArrayList<Node>(); // Incidence matrics - Macierz incydencji
 
	public HyperRelation(ObjectHE parent, Node source, Node target, String relKind){
	...
	/**
	 * check if this hyper rel contains in its connected node a node from both of given floors 
	 * @param floor1
	 * @param floor2
	 * @return
	 */
