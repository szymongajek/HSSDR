...
public class Path {
	...
	// dodaje nowy punkt, je�li le�y na jednej linii z poprzednim, przed�u�a poprzedni� �cian�
	...
	//sprawdza czy ostatni punkt i pierwszy nie tworz� �ciany
	...
	public boolean contains (int i, int j){
		// sprawdza czy podany punkt nalezy do punkt�w �cie�ki, lub czy nale�y do linii ��cz�cej punkty tej �cie�ki
	...
	public boolean containsTwoPointsInOrOnBorder (int x1, int y1,int x2, int y2 ){
		// sprawdza czy podane dwa punkty naleza do punkt�w �cie�ki, lub czy nale�a do linii ��cz�cej punkty tej �cie�ki, lub czy sa w interior
...
//		 zwraca orientacje  i-tego odcinka w sciezce, 
	...
	void makeclockwise(){
		// jesli potrzeba ustawia Path w kolejno�ci zgodnie z ruchem wsk zegara
...
//							dodajemy do sciezki second
		...
		Path retInc= new Path(editedPath);//dodajemy do �cieki na pocz�tku linie dzielaca

		//		 tworzymy sciezke od intersect1 do intersect2, po edited i od intersect2 do intersect1 po readyForDivision idac do tylu
		Path retDec= new Path(editedPath);	// dodajemy do �cie�ek na pocz�tku linie dzielaca
